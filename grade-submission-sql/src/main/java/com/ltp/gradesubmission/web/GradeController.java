...
public class GradeController {
    ...
    public ResponseEntity<List<Grade>> getCourseGrades(@PathVariable Long coursetId) {
        return new ResponseEntity<>(gradeService.getCourseGrades(coursetId), HttpStatus.OK);
    }
